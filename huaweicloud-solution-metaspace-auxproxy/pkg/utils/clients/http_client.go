...
// NewHttpsClientWithoutCerts new http client without certificates
...
// NewHttpsClient new http client without certificates
...
// JSONEncodeRequest encode http body to json string
func JSONEncodeRequest(method, url string, v interface{}) (*http.Request, error) {
	if v == nil {
	...
	return http.NewRequest(method, url, bytes.NewReader(requestBody))
}
